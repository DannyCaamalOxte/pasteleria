...
@section('titulo','Historial de ventas suc. Citilcum')
@section('contenido')
 ...
 <div class="row">
 	<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-12">
				<div align="center">
					<h4>Detalles de ventas suc. Citilcum</h4>
...
@push('scripts')
	...
	<script type="text/javascript" src="js/apis/apiVentashechasc.js"></script>
@endpush
