...
@section('titulo','ventas suc. Citilcum')
@section('contenido')
...
<div class="modal fade" id="modalBusqueda" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form>
          <div class="form-row">
          	...
          	<div class="col-md-6">
						...
						<input type="text" class="form-control mb-3" placeholder="SKU del producto" aria-label="Recipient's username" aria-describedby="basic-addon2" v-model="skuc"
	  					v-on:keyup.enter="buscarProducto()">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" style="background-image: url(img/fondo4.jpg);">Cerrar</button>
        <button type="button" class="btn btn-primary" @click="buscarProducto()" ::="skuc" data-dismiss="modal" style="background-image: url(img/fondo4.jpg);">Agregar y cerrar</button>
      </div>
    </div>
  </div>
</div>
...
@push('scripts')
	...
	<script type="text/javascript" src="js/apis/apiVentac.js"></script>
