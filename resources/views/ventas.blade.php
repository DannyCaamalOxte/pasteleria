				...
				<div class="col-md-12">
					...
					<table class="table table-bordered">
						<thead>
							...
							<th style="text-align: center" class="table-danger">OPERACIONES</th>
...
<div class="modal fade" id="modalBusqueda" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary" @click="buscarProducto()" v-model="sku" data-dismiss="modal">Agregar y cerrar</button>
      </div>
    </div>
  </div>
</div>
